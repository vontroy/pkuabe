...
public class MysqlClientFactoryBean extends CacheableObjectFactoryBean {
     ...
     * (non-Javadoc)
     * 
     * @see CacheableObjectFactoryBean#getKey()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see CacheableObjectFactoryBean#doCreateInstance()
     */
    @Override
    protected Object doCreateInstance() throws Exception {
        if (StringUtils.isBlank(this.jdbcUrl)) {
            ApiLogger.warn("MysqlClientFactoryBean jdbcUrl is empty,so return null");
            return null;
        }
        ...
        ApiLogger.info("MysqlClientFactoryBean create instance with jdbc url:" + dataSource.getJdbcUrl());
        return dataSource;
    }
